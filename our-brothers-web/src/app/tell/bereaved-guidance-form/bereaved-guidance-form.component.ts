...
const traningMeetingsConst: GuidanceMeeting[] = [
  {
    label: "29.03.20 בבאר שבע בין השעות 17:30-21:30, משרדי WEWORK, רח' חלקיקי האור 16",
    value: 'm1'
  },
  {
  ...
  {
    label: "01.04.20 בירושלים בין השעות 18:00-22:00, משרדי WEWORK, רח' קינג ג'ורג' 20",
    value: 'm3'
  },
  {
    label: "02.04.20 בחיפה בין השעות 17:00-21:00, משרדי WEWORK, רח' דרך העצמאות 45",
    value: 'm4'
  }
];
