...
export const qnaBorthers: QNAItem[] = [
  ...
  },
  {
    ...
    answer: `האחים והאחיות שמגיעים לערבים לספר את סיפורם מוזמנים לקחת חלק ביום הכנה (יהיו סדנאות הדרכה פרקטיות וכן כלים רגשיים) לבניית הערב. ניתן להוריד את <a target="_blank" href="/">ערכת האח<a/>, המתכללת את הכלים הניתנים ביום זה.`
  },
  {
  ...
  },
  {
    ...
    answer: `מיד לאחר השיבוץ לאירוח, תגיע ל<a target="_blank" href="/participate">'דף האירוח'<a/> עם כל הפרטים הרלוונטים וכן תקבל דואר אלקטרוני הכולל את הפרטים הללו. במקביל, יקבל המארח את פרטי ההתקשרות שלך ויצור איתך קשר לחיבור ותיאום ציפיות. בשיחה חשוב להעלות מס' נושאים: צורך שלך בכלים ואביזרים שונים (כמו מקרן, מסך וכו'), הבנת פרטי קהל השומעים שיגיעו לערב, הבהרת נקודות חשובות, לשתף באורחים שרוצים להתלוות אליך לערב, האם יש צורך בעזרה כלשהי וכיוצ"ב. כמו כן, המארח שלך יקבל <a target="_blank" href="/">ערכת אירוח<a/> וניתן להסב את תשומת ליבו לקריאתה.`
  },
  {
    question: 'מה אני צריך להכין לערב?',
    answer: `מומלץ לעיין ב<a target="_blank" href="/">'ערכת אח'<a/> בה מפורט על ההכנה לקראת הערב. בכל מקרה אנו ממליצים להביא איתך לערב אמצעים ויזואלים: תמונות, מצגת, סרט. קטעי קריאה. מוזמן לצפות <a target="_blank" href="/">בהרצאתו<a/> של ד"ר צוריאל ראשי המעלה מספר טיפים חשובים לקראת הערב.
    <br/>
  ...
  {
    question:
      'אני משתמש בסרטונים ותמונות בערב, האם אתם מספקים מקרן או שאני אחראי?',
...
export const qnaHosts: QNAItem[] = [
  ...
  },
  {
    ...
    answer: `לאחר שיבוץ האח/ות בביתך, יש להוציא פרסום עם שמו של האח ולהפיץ בין חברים ומדיות חברתיות. <a target="_blank" href="/">בערכת המארח<a/> ניתן למצוא גם הזמנות לשיתוף ברשתות החברתיות השונות. `
  },
  {
  ...
  },
  {
    ...
    answer: `כאשר אח ישתבץ לאירוח אצלך, תקבל מסרון ומייל עם פרטיו. חשוב לקרוא על הנופל באתר <a target="_blank" href="https://www.izkor.gov.il/">יזכור<a/>, לבצע שיחת תיאום ציפיות או לקיים מפגש הכרות מקדים עם האח, וכן ישלח אליך <a target="_blank" href="/">ערכת אירוח<a/>.`
  },
  {
